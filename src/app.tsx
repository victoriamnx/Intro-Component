...
function App() {
  return (
    <div
      id="main"
      className="w-screen h-screen flex gap-[2.81rem] max-[768px]:gap-[0rem] max-[768px]:flex-col items-center justify-center bg-[#FF7979] font-poppins max-[768px]:text-center p-[1.5rem]"
    >
      ...
      <div className="flex flex-col gap-[1.5rem]">
        ...
        >
          ...
          <p className="text-[0.6875rem] text-[#BAB7D4] font-medium normal-whitespace lg:whitespace-nowrap select-none">
            ...
            <a
              href=""
              className="text-primary font-bold leading-[1.3125rem] hover:underline"
            >
              {" "}
              Terms and Services
            </a>
